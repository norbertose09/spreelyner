                ...
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        ...
                        <tr>
                            ...
                            <td class="align-middle">$ {{ $cart->unit_price }}</td>
                            ...
                            <form action="/users/cart/{{ $cart->id }}" method="POST">
                                @method('DELETE')
                                @csrf
                ...
                <div class="bg-light p-30 mb-5">
                    <div class="border-bottom pb-2">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            @endphp
                            <h6 class="font-weight-medium">$ {{ $charges }}</h6>
                        </div>
                    </div>
                    <div class="pt-2">
                        <div class="d-flex justify-content-between mt-2">
                            <h5>Total</h5>
                            @php
                                $finaltotal = $totalprice + $charges;
                            @endphp
                            <h5>$ {{ $finaltotal }}</h5>
                        </div>
                        <a href="/users/checkout/{{ $cart->id }}" class="btn btn-block btn-primary font-weight-bold my-3 py-3">Proceed To Checkout</a>
                    </div>
                </div>
            </div>
        </div>
