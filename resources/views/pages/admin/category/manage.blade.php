     ...
     <nav class="relative container mx-auto p-6 pl-32">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="hidden md:flex space-x-12">
                ...
                <a href="/admin/category/create" class="hover:text-darkGrayishBlue font-bold">Create</a>
...
<div class="container mx-auto flex flex-col md:flex-row gap-5 justify-center items-center">
    ...
    <div class="bg-white rounded text-gray-500 shadow-lg shadow-sky-100 py-8">
        <h1 class="text-2xl text-gray-500 text-center">{{$noofcat}}</h1>
        <h1 class="text-2xl text-gray-500 uppercase text-center">Categories</h1>
        </div>
        </div>
    </div>
...
<tr class="hover:bg-gray-200">
    <td class="p-3 text-sm text-gray-700 whitespace-nowrap">{{$category->name}}</td>
    <td class="p-3 text-sm text-gray-700"><img src="{{ asset('storage/' . $category->image) }}" alt="" class="h-24 object-cover"></td>
    <td class="p-3 text-sm text-gray-700">
      
            <a href="/admin/category/edit/{{$category->id}}" class="bg-sky-500 text-white rounded py-1 px-6">Edit</button></td>
    <td class="p-3 text-sm text-gray-700">
...
@endforeach
@else 
<p>No category available <a href="/admin/category/create" class="underline text-blue-200">New</a></p>
