        ...
        <div class="container mx-auto py-40 px-6">
            <div class="flex flex-col md:flex-row w-12/12 bg-white mx-auto rounded-xl md:rounded-tr-none md:rounded-bl-none md:rounded-tl-xl md:rounded-br-xl overflow-hidden shadow-lg">
               ...
               <div class="w-full md:w-1/2 py-16 px-12">
                <h2 class="text-2xl mb-4 text-black uppercase text-center">Create New Admin</h2>
                ...
                <form action="/admin/authenticate" method="POST">
                 ...
                 <div class="flex flex-col justify-center items-center">
                        <input type="text" name="username" id="" placeholder="Username" class="border-b-2 border-gray-300 py-1 px-2 mb-4 w-full">
                        @error('username')
                        <p>{{$message}}</p>
                        @enderror
                        ...
                        <input type="password" name="password_confirmation" id="" placeholder="Confirm Password" class="border-b-2 border-gray-300 py-1 px-2 mb-4 w-full">
                        ...
                        <!--Button-->
                        <div class="mt-5">
                            <button class="rounded w-full bg-gray-900 py-3 text-center text-white">Sign Up</button>
                        </div>
                    </div>
                </form>
               </div>
